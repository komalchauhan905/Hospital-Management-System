...
if(!empty($_POST["specilizationid"])) 
{
 ...
 $sql=mysqli_query($db,"select doctorName,id from doctors where specilization='".$_POST['specilizationid']."'");?>
...
if(!empty($_POST["doctor"])) 
{
 ...
 $sql=mysqli_query($db,"select docFees from doctors where id='".$_POST['doctor']."'");
 while($row=mysqli_fetch_array($sql))
 	{?>
